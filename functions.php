...
function parallax_one_scripts() {
	...
	$parallax_one_frontpage_animations = get_theme_mod('paralax_one_enable_animations');
	if( !empty( $parallax_one_frontpage_animations ) && $parallax_one_frontpage_animations && 'posts' == get_option( 'show_on_front' ) && is_front_page() ) {
