...
jQuery( document ).ready( function( $ ) {
    ...
    if( !isMobile.any() && jQuery('#parallax_move').length>0 ){
        ...
        var parallax_one_bigTitle_logo_height;
        jQuery('.only-logo img').load(function(){
            parallax_one_bigTitle_logo_height = $parallax_one_bigTitle_logo.height();
...
jQuery( document ).ready( function( $ ) {
    ...
    var parallax_one_navigation_height;
    var parallax_one_bigTitle_height;
    var $parallax_one_bigTitle_logo;

    var parallax_one_bigTitle_logo_height;

    jQuery(window).load(function(){
        
        parallax_one_navigation_height  = jQuery('.sticky-navigation').outerHeight();
        parallax_one_bigTitle_height    = jQuery('#parallax_header').outerHeight();
        $parallax_one_bigTitle_logo     = jQuery('.only-logo');
            parallax_one_bigTitle_logo_height = $parallax_one_bigTitle_logo.height();
            $parallax_one_bigTitle_logo.css({
                'height':   parallax_one_bigTitle_logo_height,
    ...
    jQuery(window).scroll(function () {
        ...
        if ( parallax_one_headerDistanceButton-50 <= parallax_one_headerDistanceLogo+parallax_one_bigTitle_logo_height ) {
            ...
            if ( parallax_one_bigTitle_height-parallax_one_scrollTop > parallax_one_navigation_height+parallax_one_bigTitle_logo_height+$('#intro_section_text_3').height()+parallax_one_navigation_height+150 ) {
                document.getElementById('inpage_scroll_btn').style.top = parallax_one_bigTitle_logo_position + 55 + parallax_one_bigTitle_logo_height + "px";
            }
        } else {
            $('#intro_section_text_3').css({
