...
if ( ! function_exists( 'parallax_one_translate_single_string' ) ) {
	/**
...
if ( ! function_exists( 'parallax_one_pll_string_register_helper' ) ) {
	/**
...
if ( ! function_exists( 'parallax_one_filter_translations' ) ) {
	/**
...
if ( ! function_exists( 'parallax_include_translations' ) ) {
	/**
